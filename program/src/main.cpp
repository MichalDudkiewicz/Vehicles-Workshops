...
int main() {
    ...
    cout << endl;
    ClientPtr klient2 = make_shared<Client>("Jacek", "Dudkiewicz", "1234", "a", 2, "b", 3);
    ClientPtr klient3 = make_shared<Client>("Andrzej", "Dudkiewicz", "1234", "a", 2, "b", 3);
    ClientPtr klient4 = make_shared<Client>("Anna", "Dudkiewicz", "1234", "a", 2, "b", 3);
